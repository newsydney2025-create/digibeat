...
import { TikTokVideo, TikTokAccount, Platform } from '@/types/database'
...
export default function VideoDetailTable({ videos, accounts, platform = 'tiktok' }: VideoDetailTableProps) {
        ...
        <div className="glass-panel rounded-xl overflow-hidden flex flex-col h-full">
            <div className="p-4 border-b border-white/5 flex justify-between items-center">
                <h3 className="text-sm font-bold text-gray-400 uppercase tracking-widest flex items-center gap-2">
                    ...
                    {platform === 'instagram' ? 'Latest Reels Details' : 'Latest Video Details'}
                </h3>
                <span className="text-xs text-gray-600 font-mono">{videos.length} {platform === 'instagram' ? 'reels' : 'videos'} loaded</span>
            </div>
