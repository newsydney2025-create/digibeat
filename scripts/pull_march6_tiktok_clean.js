...
const supabaseOptions = {
    global: { headers: { Authorization: `Bearer ${supabaseServiceRoleKey}`, 'apikey': supabaseServiceRoleKey } }
};
const supabase = createClient(supabaseUrl, supabaseServiceRoleKey, supabaseOptions);
